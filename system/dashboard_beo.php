...
/**
 * KPRM - BEO Dashboard
 * Dashboard for Business Executive Officers
 * Shows statistics and activities for allowed clients only
 */
...
// Get allowed clients for this BEO
$allowed_clients = get_user_allowed_clients($user_id, 'BEO');
$client_filter = '';
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="mb-1">
                    ...
                    <strong>BEO Dashboard</strong>
                </h4>
                <p class="text-muted small mb-0">Overview of your cases and tasks for assigned clients</p>
            </div>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="card border-start border-primary border-4">
                                <div class="card-body">
                                    ...
                                    <a href="<?= $base_url?>public/add_new_case.php?client_id=<?= $client['id'] ?>" class="btn btn-sm btn-primary">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 mb-4">
                <div class="card shadow-sm">
                    ...
                    <div class="card-footer text-center bg-white">
                        <a href="<?= $base_url?>public/case_manage.php?cstatus=PENDING" class="btn btn-sm btn-warning">View All Pending</a>
                    </div>
                </div>
            </div>
        </div>
